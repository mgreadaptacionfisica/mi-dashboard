...
export async function insertObjetivoClienteFaseRemote(objetivo) {
  ...
  if (error) avisaErrorGuardado('[objetivosClienteFase] insert error:', error)
}
...
export async function updateObjetivoClienteFaseRemote(id, patch) {
  ...
  if (error) avisaErrorGuardado('[objetivosClienteFase] update error:', error)
}
...
export async function deleteObjetivoClienteFaseRemote(id) {
  ...
  if (error) avisaErrorGuardado('[objetivosClienteFase] delete error:', error)
}
