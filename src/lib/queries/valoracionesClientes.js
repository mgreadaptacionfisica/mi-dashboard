...
function fromRow(row) {
  return {
    ...
    spadi: row.spadi || {},
    tampa: row.tampa || {},
    diagnosticoDiferencial: row.diagnostico_diferencial || {},
    redDeterminantes: row.red_determinantes || {},
...
function toRow(v) {
  return {
    ...
    spadi: v.spadi || {},
    tampa: v.tampa || {},
    diagnostico_diferencial: v.diagnosticoDiferencial || {},
    red_determinantes: v.redDeterminantes || {},
